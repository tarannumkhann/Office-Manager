<%-- 
    ...
    Created on : 1 Mar, 2024, 8:10:03 PM
    Author     : Tarannum
--%>
...
<center>
    ...
    <span style="font-size: 30px;color: dodgerblue;font-style: normal;">Employee List</span><br>
    <table width="1000" border="2" bgcolor="white" cellpadding="5" cellspacing="0">
        <br>
        <tr bgcolor="yellow"><th>S.No.</th><th>Employee Code</th><th>Employee Name</th><th>Date of Birth</th><th>Gender</th><th>Post</th><th>Address</th><th>City</th><th>Contact</th><th>E mail</th><th>ID Name</th><th>ID Number</th>
